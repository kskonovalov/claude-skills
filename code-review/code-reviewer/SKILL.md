...
Для каждого выбранного аспекта выполни соответствующий `code-review-*` скилл на том же входе. Каждый пишет
свой отчёт самостоятельно. Передай каждому: вход, язык, любые пользовательские override'ы.
